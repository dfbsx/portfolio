import { experiences } from "@/components/home/sections/homeData";
import {
  IconCalendar,
  IconExternalLink,
  IconMapPin,
          ...
          >
            <div className="p-6 sm:p-7">
              <div className="flex gap-4 sm:gap-5">
                <PortfolioHeaderMarkView mark={job.mark} variant="rose" />
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1">
                    {job.orgUrl ? (
                      ...
                      <span className="text-sm font-semibold text-rose-700 dark:text-rose-700">
                        {job.org}
                      </span>
                    )}
                  </div>
              ...
              <ul className="mt-5 space-y-2.5 border-t border-stone-200/50 pt-5 text-sm leading-relaxed text-stone-600 dark:border-stone-200/50 dark:text-stone-600">
                {job.highlights.map((line, i) => (
                  <li key={`${job.title}-exp-${i}`} className="flex gap-2.5">
